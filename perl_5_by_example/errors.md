...
Perl provides a special logical operator that 
...
The <TT>die()</TT> function is used to quit your script and 
...
The <TT>warn()</TT> function has the same functionality that <TT>die()</TT> does except the script is not exited. This 
...
You can use the <TT>eval()</TT> function to trap a normally fatal error: 
